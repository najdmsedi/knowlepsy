class UtilsDate {
    ...
    static formatHHmmDDMMYYYY(date: { getHours: () => any; getMinutes: () => any; getDate: () => any; getMonth: () => number; getFullYear: () => any; }) {
      if (!date) {
        return "";
      }
      const hours = String(date.getHours()).padStart(2, '0');
    ...
    static formatDuration(duration: { minutes: any; seconds: number; }) {
